...
def balanced_l1_loss(bbox_pred,
                     bbox_targets,
                     bbox_inside_weights,
    ...
    in_loss_box = torch.where(
        abs_in_box_diff < beta,
        alpha / b * (b * abs_in_box_diff + 1) * torch.log(b * abs_in_box_diff / beta + 1) -
        alpha * abs_in_box_diff, gamma * abs_in_box_diff + gamma / b - alpha * beta)
