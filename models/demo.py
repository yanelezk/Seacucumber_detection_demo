...
pascal_classes = np.asarray(['__background__','trepang'])
...
if __name__ == '__main__':
  ...
  myapp.CameraDisplayLable.setPixmap(QPixmap.fromImage(QTimage))
  myapp.CameraDisplayLable.setScaledContents(True)
  app.exec_()